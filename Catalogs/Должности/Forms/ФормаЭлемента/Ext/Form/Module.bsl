...
&НаКлиенте
Процедура ЯвляетсяНачальникомОтделенияПриИзменении(Элемент)
	Если Объект.ЯвляетсяНачальникомОтделения Тогда
		Объект.ЯвляетсяЗаместителемНачальникаОтделения = Ложь;
		Элементы.ЯвляетсяЗаместителемНачальникаОтделения.Доступность = Ложь;
	Иначе
		Элементы.ЯвляетсяЗаместителемНачальникаОтделения.Доступность = Истина;
	КонецЕсли;
КонецПроцедуры

&НаКлиенте
Процедура ЯвляетсяЗаместителемНачальникаОтделенияПриИзменении(Элемент)
	Если Объект.ЯвляетсяЗаместителемНачальникаОтделения Тогда
		Объект.ЯвляетсяНачальникомОтделения = Ложь;
		Элементы.ЯвляетсяНачальникомОтделения.Доступность = Ложь;
	Иначе
		Элементы.ЯвляетсяНачальникомОтделения.Доступность = Истина;
	КонецЕсли;
КонецПроцедуры
