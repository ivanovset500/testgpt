...
Процедура СоздатьПомеченныеДляПрочихСценариев(Настройки, Результат)
	...
	ОрганизацияСсылка = Справочники.Организации.НайтиПоНаименованию(Настройки.ПрочиеСценарииПрефикс1);
	...
	ФизическоеЛицоСсылка = Справочники.ФизическиеЛица.НайтиПоНаименованию(Настройки.ПрочиеСценарииПрефикс2);
