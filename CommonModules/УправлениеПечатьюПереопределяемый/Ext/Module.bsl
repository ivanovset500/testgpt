...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	СписокОбъектов.Добавить(Документы.ЛБ_ОперацияПоЗалогу);//ЛБ
	СписокОбъектов.Добавить(Документы.ЛБ_ПрейскурантЦенНаМеталлы);//ЛБ
	СписокОбъектов.Добавить(Документы.ЛБ_ПрейскурантЦенНаДрагоценныеКамни);//ЛБ
	СписокОбъектов.Добавить(Документы.ЛБ_ПрейскурантПроцентныхСтавок);//ЛБ
	СписокОбъектов.Добавить(Документы.ЛБ_БланкиЗалоговыхБилетов);//ЛБ
	СписокОбъектов.Добавить(Документы.ЛБ_ПриказУсловияПредоставленияЗаймов);//ЛБ
    СписокОбъектов.Добавить(Документы.ЛБ_АкцииМеталлы);//ЛБ
    СписокОбъектов.Добавить(Документы.ЛБ_АкцииПроцентныеСтавки);//ЛБ 
    СписокОбъектов.Добавить(Документы.ЛБ_Доверенности);//ЛБ 
	СписокОбъектов.Добавить(Документы.ЛБ_УстановитьЛомбардыВОтделение);//ЛБ
	СписокОбъектов.Добавить(Документы.ЛБ_УстановитьТекущийШаблонПриказа_ПроцентныеСтавки);//ЛБ
	СписокОбъектов.Добавить(Документы.ЛБ_УстановитьТекущийШаблонПриказа_Вставки);//ЛБ
    СписокОбъектов.Добавить(Документы.ЛБ_УстановитьТекущийШаблонПриказа_Металлы);//ЛБ
	СписокОбъектов.Добавить(Документы.ЛБ_Инвентаризация);//ЛБ  
	СписокОбъектов.Добавить(Документы.ЛБ_РегламентноеНачислениеПроцентов);//ЛБ 
	СписокОбъектов.Добавить(Документы.ЛБ_ПриходныйКассовыйОрдер);//ЛБ 
	СписокОбъектов.Добавить(Документы.ЛБ_РасходныйКассовыйОрдер);//ЛБ   
	СписокОбъектов.Добавить(Документы.ЛБ_ОтменаПКО);//ЛБ
    СписокОбъектов.Добавить(Документы.ЛБ_ОтменаРКО);//ЛБ 
	СписокОбъектов.Добавить(Документы.ЛБ_ЭлектронныйГрафикРаботы);//ЛБ 
	СписокОбъектов.Добавить(Документы.ЛБ_ПриказРежимРаботы);//ЛБ 
	СписокОбъектов.Добавить(Документы.ЛБ_Реализация);//ЛБ
