...
Процедура ПриОпределенииПараметровПоискаДублей(Знач ИмяОбъектаМетаданных, ПараметрыПоиска, Знач ДополнительныеПараметры,
	...
	Если ИмяОбъектаМетаданных = Метаданные.Справочники._ДемоПартнеры.ПолноеИмя() 
		Или ИмяОбъектаМетаданных = Метаданные.Справочники.Организации.ПолноеИмя() Тогда
...
Процедура ПриЗаполненииВидовОграниченийПравОбъектовМетаданных(Описание) Экспорт
	...
	|Документ._ДемоПоручениеЭкспедитору.Чтение.ФизическиеЛица
	...
	|Документ._ДемоПоручениеЭкспедитору.Изменение.ФизическиеЛица
	...
	|РегистрСведений._ДемоРаботникиОрганизаций.Чтение.ФизическиеЛица
	|РегистрСведений._ДемоРаботникиОрганизаций.Чтение.Организации
	|РегистрСведений._ДемоРаботникиОрганизаций.Изменение.ФизическиеЛица
	...
	|РегистрСведений._ДемоРеестрСкладскихДокументов.Чтение.Организации
...
Процедура ПриЗаполненииОграниченияДоступа(Список, Ограничение) Экспорт
	...
	Если Список = Метаданные.РегистрыСведений.ИсполнителиЗадач Тогда
		...
		|ГДЕ
		|	ЗначениеРазрешено(ОсновнойОбъектАдресации ТОЛЬКО Справочник.Организации)
		|	ИЛИ ЗначениеРазрешено(ДополнительныйОбъектАдресации ТОЛЬКО Справочник.Организации)
		|	ИЛИ (ТипЗначения(ОсновнойОбъектАдресации) <> Тип(Справочник.Организации) И ОсновнойОбъектАдресации <> Неопределено)
		|	ИЛИ (ТипЗначения(ДополнительныйОбъектАдресации) <> Тип(Справочник.Организации) И ДополнительныйОбъектАдресации <> Неопределено)";
...
Процедура ПриОпределенииИсточниковДанныхПечати(Объект, ИсточникиДанныхПечати) Экспорт
	...
	// Локализация
	Если Объект = "Справочник.ФизическиеЛица.Наименование" Тогда
