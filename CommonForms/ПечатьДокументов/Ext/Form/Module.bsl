...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//лб-н 
	Если Параметры.ИмяМенеджераПечати = "Документ.ЛБ_ПриказУсловияПредоставленияЗаймов" Тогда
		Копий = 2;  
	Иначе
	...
	Если ТипЗнч(МассивСсылок) = Тип("Массив")
		...
		//+МАН 02.02.26 Закомментировал т.к. вызывало ошибку при печати, после установки ЭДО от 1С.
